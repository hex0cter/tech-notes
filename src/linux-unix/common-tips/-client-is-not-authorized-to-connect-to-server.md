...
# ["Client is not authorized to connect to server" - Daniel Han's Technical Notes](https://sites.google.com/site/xiangyangsite/home/technical-tips/linux-unix/common-tips/-client-is-not-authorized-to-connect-to-server)
