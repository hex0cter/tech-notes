# [add domain name to hostname automatically when connecting to remote server](http://askubuntu.com/questions/58781/resolv-conf-keeps-getting-reset-by-something)
