...
- [Who is listening on a given tcp port on mac os x? - daniel han's technical notes](./who-is-listening-on-a-given-tcp-port-on-mac-os-x.md)
...
- [Take control of startup and login items on os x - daniel han's technical notes](./take-control-of-startup-and-login-items.md)
...
- [Using ssh as a socks proxy on mac os x - daniel han's technical notes](./using-ssh-as-a-socks-proxy-on-mac-os-x.md)
- [Macos: checking a disk for bad blocks - daniel han's technical notes](./macos-checking-a-disk-for-bad-blocks.md)
