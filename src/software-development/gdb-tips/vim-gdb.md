...
# [vim+gdb - Daniel Han's Technical Notes](https://sites.google.com/site/xiangyangsite/home/technical-tips/software-development/gdb-tips/vim-gdb)
...
cd ~/install/tar xjf vim-7.1.tar.bz2tar xzf vimgdb71-1.12.tar.gz
...
# ~/tmp/Makefilesample: sample.c factor/factor.c
...
" easwy add if ! exists("g:vimgdb_debug_file") let g:vimgdb_debug_file = "" elseif g:vimgdb_debug_file == "" call inputsave() let g:vimgdb_debug_file = input("File: ", "", "file") call inputrestore() endif call gdb("file " . g:vimgdb_debug_file)

" easwy end

在“let s:gdb_k = 1”这一行下面加上这段内容：

" easwy add call gdb("quit")
...
"""""""""""""""""""""""""""""" " vimgdb setting """""""""""""""""""""""""""""" let g:vimgdb_debug_file = ""
